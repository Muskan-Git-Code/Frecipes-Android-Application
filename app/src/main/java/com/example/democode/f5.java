...
public class f5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Animation a61 = AnimationUtils.loadAnimation(getContext(), R.anim.blink);
        iv.startAnimation(a61);

        Button bt1= (Button)v.findViewById(R.id.button12);
        ...
        Button bt2= (Button)v.findViewById(R.id.button13);
        bt2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i= new Intent(getContext(), quiz.class);
                startActivity(i);
            }
        });
